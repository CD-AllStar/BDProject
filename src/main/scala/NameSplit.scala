...
object NameSplit {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val city_name = city_names.rdd.map(x=>((x.getString(0),x.getString(1),x.getString(2),x.getString(3),x.getString(5)),x.getString(4)))
      ...
      .map(x=>Word(x._1._1,x._1._2,x._1._3,x._1._4,x._2.split("\t")(0),x._2.split("\t")(1),x._1._5,x._2.split("\t")(2)))


//    city_name.take(100).foreach(println)
    city_name.toDF.registerTempTable("NameSplit")
//
    hiveContext.sql("insert overwrite table city_name_split select uid,country,province,city,word,source,source_id,synonym from NameSplit")
